...
<body class="">
    ...
    <aside class="side-nav bg-success ">
        ...
        <ul class="list-group nav-ul">
            ...
            <li><a href="accounts.php" class="nav-accounts"><i class="bi bi-people-fill"></i> Visitor</a></li>
            ...
            <li class="li-manage">
                ...
                <ul class="list-group ul-manage mt-5">
                     <li><a href="actLogs.php" class="nav-products"><i class="bi bi-book"></i> Activity Logs</a></li>
                    ...
                    <li><a href="store.php" class="nav-products"><i class="bi bi-shop"></i> SMEs</a></li>
