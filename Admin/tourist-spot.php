            ...
            ?>
                <tr>
                    ...
                    <td>
                        ...
                        <button class="btn btn-success btnEditSpot" data-id="<?= $spot['SPOT_ID'] ?>" data-name="<?= $spot['SPOT_NAME'] ?>" data-spottype="<?= $spot['SPOT_TYPE'] ?>" data-fee="<?= $spot['FEE'] ?>" data-address="<?= $spot['ADDRESS'] ?>" data-description="<?= $spot['DESCRIPTION'] ?>"><i class="bi bi-pen"></i> </button>
                        <button class="btn btn-danger btnDeleteSpot" data-id="<?= $spot['SPOT_ID'] ?>"><i class="bi bi-trash-fill"></i></button>
                    </td>
                </tr>
            <?php
                $count++;
