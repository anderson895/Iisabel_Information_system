    ...
    <div class="products-container">
        ...
        <div class="mt-5">
            ...
            ?>
                    <hr>
                    <div class="container">
                        <button class="btn btn-danger btnDeleteProduct" data-product_name="<?= $product['PRODUCT_NAME'] ?>" data-id="<?= $product['PRODUCT_ID'] ?>" data-filename="<?= $product['PRODUCT_IMG'] ?>"><i class="bi bi-trash"></i> Delete</button>
