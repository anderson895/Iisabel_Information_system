$(document).ready(function () {
  ...
  $(".btnSpotContainer").click(function (e) {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        if (images.length > 0) {
          // Display the first image in #ts-modal-lg-img
          $("#ts-modal-lg-img").attr(
            "src",
            "../backend/SMEsImg/" + images[0].file_name
          );
    
          // Display all images in the #ts-modal-sm-img-container
          images.forEach((img) => {
            var btn = $(
          ...
          // If no images, display a default image in #ts-modal-lg-img
          $("#ts-modal-lg-img").attr("src", "../backend/SMEsImg/logo.png");
        }
      },
    });
  ...
  $(".btnAccomContainer").click(function (e) {
    ...
    $('#accomodation_id').val($(this).data("id"));
